import{_ as n,p as s,q as a,a1 as p}from"./framework-96b046e1.js";const e={},t=p(`<h1 id="_04-路由传参三种方式" tabindex="-1"><a class="header-anchor" href="#_04-路由传参三种方式" aria-hidden="true">#</a> 04 路由传参三种方式</h1><p>Vue路由传参三种方式 params传参 路由属性配置传参 query传参</p><h2 id="一、params传参" tabindex="-1"><a class="header-anchor" href="#一、params传参" aria-hidden="true">#</a> 一、params传参</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">this</span><span class="token punctuation">.</span>$router<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span><span class="token punctuation">{</span> 
