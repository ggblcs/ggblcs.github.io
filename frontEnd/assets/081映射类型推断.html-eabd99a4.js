import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},p=e(`<h1 id="_081-映射类型推断" tabindex="-1"><a class="header-anchor" href="#_081-映射类型推断" aria-hidden="true">#</a> 081 映射类型推断</h1><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">/*
由映射类型进行推断
