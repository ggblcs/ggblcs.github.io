import{_ as n,p as s,q as e,a1 as a}from"./framework-96b046e1.js";const i={},l=a(`<h1 id="_075-eggjs处理动态资源" tabindex="-1"><a class="header-anchor" href="#_075-eggjs处理动态资源" aria-hidden="true">#</a> 075 EggJs处理动态资源</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/*
    1.EggJS如何处理动态资源?
    1.1什么是插件?
    EggJS中的插件就是特殊的中间件
    用来处理那些和请求无关独立的业务逻辑
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,3),c=[l];function t(d,r){return s(),e("div",null,c)}const o=n(i,[["render",t],["__file","075EggJs处理动态资源.html.vue"]]);export{o as default};
