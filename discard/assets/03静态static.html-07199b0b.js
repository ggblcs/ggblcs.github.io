...
通过初始化块对num2赋值
通过构造方法对变量num1赋值
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="小结" tabindex="-1"><a class="header-anchor" href="#小结" aria-hidden="true">#</a> 小结</h2><p>能不用静态的尽量还是不要用静态啦，用得太多就太占内存啦。</p>`,31),d=[a];function l(u,c){return n(),e("div",null,d)}const r=i(s,[["render",l],["__file","03静态static.html.vue"]]);export{r as default};
