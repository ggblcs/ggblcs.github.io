import{_ as n,p as i,q as e,a1 as l}from"./framework-96b046e1.js";const s={},d=l(`<h1 id="_01-数据库开篇" tabindex="-1"><a class="header-anchor" href="#_01-数据库开篇" aria-hidden="true">#</a> 01 -数据库开篇</h1><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--
1.什么是数据库?
- 数据库就是存储数据的仓库
