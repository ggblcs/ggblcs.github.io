import{_ as n,p as s,q as a,a1 as t}from"./framework-96b046e1.js";const e={},p=t(`<h1 id="_04-http" tabindex="-1"><a class="header-anchor" href="#_04-http" aria-hidden="true">#</a> 04 http</h1><p>http模块，服务器模块。</p><h2 id="_01-http模块" tabindex="-1"><a class="header-anchor" href="#_01-http模块" aria-hidden="true">#</a> 01 http模块</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1.什么是HTTP模块
