import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},i=e(`<h1 id="_07-函数中this值的类型" tabindex="-1"><a class="header-anchor" href="#_07-函数中this值的类型" aria-hidden="true">#</a> 07 函数中this值的类型</h1><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 默认情况下，编译器会将函数中的this值设置为any类型，并允许程序在this值上执行任意的操作。</span>
