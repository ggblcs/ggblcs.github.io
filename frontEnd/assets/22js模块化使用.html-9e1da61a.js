import{_ as e,p as s,q as n,a1 as i}from"./framework-96b046e1.js";const a={},d=i(`<h1 id="_22-js模块化使用" tabindex="-1"><a class="header-anchor" href="#_22-js模块化使用" aria-hidden="true">#</a> 22 js模块化使用</h1><p>跨模块使用方法：</p><p>独立性测试，是否能共享。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>ES6（并列）
...
只有use了，可以全局用。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),l=[d];function t(c,u){return s(),n("div",null,l)}const v=e(a,[["render",t],["__file","22js模块化使用.html.vue"]]);export{v as default};
