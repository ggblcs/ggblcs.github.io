import{_ as n,p as s,q as e,a1 as i}from"./framework-96b046e1.js";const a={},l=i(`<h1 id="_087-模块系统" tabindex="-1"><a class="header-anchor" href="#_087-模块系统" aria-hidden="true">#</a> 087 模块系统</h1><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">/*
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),d=[l];function t(c,o){return s(),e("div",null,d)}const u=n(a,[["render",t],["__file","087模块系统.html.vue"]]);export{u as default};
