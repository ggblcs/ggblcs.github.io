import{_ as n,p as s,q as a,a1 as t}from"./framework-96b046e1.js";const p={},e=t(`<h1 id="_08-泛型类" tabindex="-1"><a class="header-anchor" href="#_08-泛型类" aria-hidden="true">#</a> 08 泛型类</h1><p>若类的定义中带有类型参数，那么它是泛型类。</p><p>泛型类的定义中，形式类型参数列表紧随类名之后。</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 定义类的方式一：类声明</span>
