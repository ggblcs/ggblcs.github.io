import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},l=e(`<h1 id="_04-原子表与原子组" tabindex="-1"><a class="header-anchor" href="#_04-原子表与原子组" aria-hidden="true">#</a> 04 原子表与原子组</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">let</span> tel <span class="token operator">=</span> <span class="token string">&quot;010-2654215&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),c=[l];function i(o,p){return s(),a("div",null,c)}const d=n(t,[["render",i],["__file","04原子表与原子组.html.vue"]]);export{d as default};
