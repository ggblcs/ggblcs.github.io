import{_ as e,p as i,q as l,a1 as n}from"./framework-96b046e1.js";const t={},a=n(`<h1 id="_02-jsp脚本元素" tabindex="-1"><a class="header-anchor" href="#_02-jsp脚本元素" aria-hidden="true">#</a> 02 JSP脚本元素</h1><hr><h2 id="title-02-jsp脚本元素、指令" tabindex="-1"><a class="header-anchor" href="#title-02-jsp脚本元素、指令" aria-hidden="true">#</a> title: 02 JSP脚本元素、指令</h2><h2 id="_01jsp脚本元素" tabindex="-1"><a class="header-anchor" href="#_01jsp脚本元素" aria-hidden="true">#</a> 01JSP脚本元素</h2><h3 id="_1-1jsp脚本元素及其组成" tabindex="-1"><a class="header-anchor" href="#_1-1jsp脚本元素及其组成" aria-hidden="true">#</a> 1.1JSP脚本元素及其组成</h3><p>在JSP中嵌入的服务端（即web后端）运行的小程序称为脚本，而JSP支持的服务端脚本语言是Java，所以<strong>这些脚本其实就是Java程序</strong>。通常把脚本元素分为“表达式、声明、scriptlet”。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>graph LR
A[长方形] -- 链接 --&gt; B((圆))
A --&gt; C(圆角长方形)
B --&gt; D{菱形}
C --&gt; D
