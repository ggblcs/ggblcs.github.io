import{_ as n,p as s,q as a,a1 as t}from"./framework-96b046e1.js";const p={},e=t(`<h1 id="_025-日志记录" tabindex="-1"><a class="header-anchor" href="#_025-日志记录" aria-hidden="true">#</a> 025 日志记录</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/*
1.什么是日志?
- 日志在企业开发中有着不可或缺的作用，
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,5),o=[e];function i(c,l){return s(),a("div",null,o)}const r=n(p,[["render",i],["__file","025日志记录.html.vue"]]);export{r as default};
