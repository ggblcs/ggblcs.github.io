import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},p=e(`<h1 id="_15-枚举成员" tabindex="-1"><a class="header-anchor" href="#_15-枚举成员" aria-hidden="true">#</a> 15 枚举成员</h1><p>主要是一些概念性的东西，有点鸡肋，可看可不看。</p><p>每个枚举成员都有一个值，根据枚举成员值的定义，可以将枚举成员换分为两大类</p><ul><li>常量枚举成员</li><li>计算枚举成员</li></ul><h2 id="_1-常量枚举成员" tabindex="-1"><a class="header-anchor" href="#_1-常量枚举成员" aria-hidden="true">#</a> 1 常量枚举成员</h2><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 初值为0</span>
