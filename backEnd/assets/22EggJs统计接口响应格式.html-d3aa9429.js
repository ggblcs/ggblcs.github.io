import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const p={},t=e(`<h1 id="_22-eggjs统计接口响应格式" tabindex="-1"><a class="header-anchor" href="#_22-eggjs统计接口响应格式" aria-hidden="true">#</a> 22 EggJs统计接口响应格式</h1><p>使用扩展实现模板</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
