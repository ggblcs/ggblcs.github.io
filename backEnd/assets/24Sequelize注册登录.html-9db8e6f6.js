import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},p=e(`<h1 id="_24-sequelize注册登录" tabindex="-1"><a class="header-anchor" href="#_24-sequelize注册登录" aria-hidden="true">#</a> 24 Sequelize注册登录</h1><p>导入模型对象，模型对象.方法名即可操作数据库增删改查。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/* Sequelize处理注册登录
