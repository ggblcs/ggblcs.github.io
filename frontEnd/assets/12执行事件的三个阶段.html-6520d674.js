import{_ as n,p as s,q as a,a1 as t}from"./framework-96b046e1.js";const e="/frontEnd/assets/042-5-badc2b5c.jpg",i={},c=t('<h1 id="_12-执行事件的三个阶段" tabindex="-1"><a class="header-anchor" href="#_12-执行事件的三个阶段" aria-hidden="true">#</a> 12 执行事件的三个阶段</h1><img src="'+e+`" alt="Screenshot_20201030_150455" style="zoom:50%;"><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">*</span><span class="token punctuation">{</span>
