import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},p=e(`<h1 id="_29-预渲染适配移动端问题" tabindex="-1"><a class="header-anchor" href="#_29-预渲染适配移动端问题" aria-hidden="true">#</a> 29 预渲染适配移动端问题</h1><p>详见课时182，使用正则匹配标签并换成空串。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 以下代码是安装了预渲染的插件之后自动添加的</span>
