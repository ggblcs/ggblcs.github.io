import{_ as n,p as s,q as a,a1 as p}from"./framework-96b046e1.js";const t={},e=p(`<h1 id="_06-express处理路由下" tabindex="-1"><a class="header-anchor" href="#_06-express处理路由下" aria-hidden="true">#</a> 06 Express处理路由下</h1><p>新学</p><p>使用 router 而不是监听 get 和 post 来处理路由。</p><p>源码</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 1.导入express</span>
