import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const o={},p=e(`<h1 id="_21-顶端类型unknown" tabindex="-1"><a class="header-anchor" href="#_21-顶端类型unknown" aria-hidden="true">#</a> 21 顶端类型unknown</h1><p>unknown与any非常相似,但更安全.</p><p>any是顶端类型,所以任何类型都可以赋值给any unknown是顶端类型,所以任何类型都可以赋值给unknown</p><p>any类型可以赋值给其他类型,比如string,number等 unknown类型 只可以 赋值给any类型和unknown类型 unknown类型 不可以 赋值给其他类型.</p><p>unknown类型也不可以进行大部分操作,除非细分为具体类型.</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 其他类型赋值给unknown</span>
...
<span class="token keyword">function</span> <span class="token function">fn2</span><span class="token punctuation">(</span>message<span class="token operator">:</span><span class="token builtin">unknown</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),t=[p];function l(c,i){return s(),a("div",null,t)}const k=n(o,[["render",l],["__file","21顶端类型unknown.html.vue"]]);export{k as default};
