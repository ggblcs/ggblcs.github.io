import{_ as n,p as s,q as a,a1 as p}from"./framework-96b046e1.js";const t={},e=p(`<h1 id="_006-项目结构下" tabindex="-1"><a class="header-anchor" href="#_006-项目结构下" aria-hidden="true">#</a> 006 项目结构下</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>根
├─ bin
│  └─ www.js
├─ model
│  └─ ReslutModel.js
