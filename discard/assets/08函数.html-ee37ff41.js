import{_ as i,p as e,q as n,a1 as a}from"./framework-96b046e1.js";const d={},l=a(`<h1 id="_08-函数" tabindex="-1"><a class="header-anchor" href="#_08-函数" aria-hidden="true">#</a> 08 函数</h1><h2 id="_01-形参与实参" tabindex="-1"><a class="header-anchor" href="#_01-形参与实参" aria-hidden="true">#</a> 01 形参与实参</h2><div class="language-C++ line-numbers-mode" data-ext="C++"><pre class="language-C++"><code>int add(int num1,int num2) //定义中的num1，2称为形式参数，形参
{
	int sum = num1 + num2;
	return sum;
}
...
fun();	   //效果一样
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,28),s=[l];function r(c,u){return e(),n("div",null,s)}const t=i(d,[["render",r],["__file","08函数.html.vue"]]);export{t as default};
