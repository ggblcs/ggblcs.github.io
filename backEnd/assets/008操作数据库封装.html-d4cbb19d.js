import{_ as n,p as s,q as a,a1 as t}from"./framework-96b046e1.js";const p={},e=t(`<h1 id="_008-操作数据库封装" tabindex="-1"><a class="header-anchor" href="#_008-操作数据库封装" aria-hidden="true">#</a> 008 操作数据库封装</h1><p>转接上文 006项目结构下</p><blockquote><p>首先安装驱动 mysql</p></blockquote><p><code>user.js</code> if 语句下新增</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> exc <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;../db/mysql&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span> 
