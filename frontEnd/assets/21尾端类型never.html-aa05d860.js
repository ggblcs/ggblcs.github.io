import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},p=e(`<h1 id="_21-尾端类型never" tabindex="-1"><a class="header-anchor" href="#_21-尾端类型never" aria-hidden="true">#</a> 21 尾端类型never</h1><p>尾端类型是所有其他类型的子类型,由于一个值不可能同时属于所有类型,例如一个值不可能既是字符串类型,又是数字类型.<strong>因此尾端类型中不包含任何值.</strong></p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// Never类型</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),o=[p];function c(i,l){return s(),a("div",null,o)}const u=n(t,[["render",c],["__file","21尾端类型never.html.vue"]]);export{u as default};
