import{_ as n,p as s,q as e,a1 as a}from"./framework-96b046e1.js";const i={},l=a(`<h1 id="_078-索引访问操作符" tabindex="-1"><a class="header-anchor" href="#_078-索引访问操作符" aria-hidden="true">#</a> 078 索引访问操作符</h1><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 通过[]索引类型访问操作符, 我们就能得到某个索引的类型</span>
