import{_ as n,p as s,q as e,a1 as a}from"./framework-96b046e1.js";const i={},l=a(`<h1 id="_02-eggjs基本使用" tabindex="-1"><a class="header-anchor" href="#_02-eggjs基本使用" aria-hidden="true">#</a> 02 EggJs基本使用</h1><h2 id="_1-eggjs基本使用提炼" tabindex="-1"><a class="header-anchor" href="#_1-eggjs基本使用提炼" aria-hidden="true">#</a> 1.EggJs基本使用提炼</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token number">2</span>.手动安装手动配置
