import{_ as s,p as n,q as a,a1 as p}from"./framework-96b046e1.js";const e={},t=p(`<h1 id="_89-滚动组件封装上" tabindex="-1"><a class="header-anchor" href="#_89-滚动组件封装上" aria-hidden="true">#</a> 89 滚动组件封装上</h1><h2 id="_01-安装" tabindex="-1"><a class="header-anchor" href="#_01-安装" aria-hidden="true">#</a> 01 安装</h2><p>下载iscroll</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>cnpm <span class="token function">install</span> --save-d iscroll
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),o=[t];function l(c,r){return n(),a("div",null,o)}const u=s(e,[["render",l],["__file","089滚动组件封装上.html.vue"]]);export{u as default};
