import{_ as n,p as s,q as a,a1 as p}from"./framework-96b046e1.js";const e={},t=p(`<h1 id="_07-类型别名和接口异同" tabindex="-1"><a class="header-anchor" href="#_07-类型别名和接口异同" aria-hidden="true">#</a> 07 类型别名和接口异同</h1><p>书·</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 接口和类型别名是相互兼容的</span>
