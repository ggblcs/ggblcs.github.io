import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const i={},l=e(`<h1 id="_02-path" tabindex="-1"><a class="header-anchor" href="#_02-path" aria-hidden="true">#</a> 02 path</h1><p>Buffer模块已经添加到了globel中，所以不用导入，path模块没有，所以需要导入。</p><p>path模块时系统模块，导入时不需要加路径<code>./</code>。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token number">1.</span><span class="token function">路径模块</span><span class="token punctuation">(</span>path<span class="token punctuation">)</span>
封装了各种路径相关的操作
