import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},p=e(`<h1 id="_15-原子组与原子表" tabindex="-1"><a class="header-anchor" href="#_15-原子组与原子表" aria-hidden="true">#</a> 15 原子组与原子表</h1><p>原子表就是一个中括号[]，里面匹配是任意的某一个都行。值得注意的是，原子组只代表一个字符。剩下就不多说了。</p><p>原子组()小括号。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 匹配一个日期，要求日期格式是-或/连接都能正常匹配</span>
