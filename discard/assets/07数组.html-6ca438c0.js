import{_ as a,p as e,q as n,a1 as s}from"./framework-96b046e1.js";const i={},r=s(`<h1 id="_07-数组" tabindex="-1"><a class="header-anchor" href="#_07-数组" aria-hidden="true">#</a> 07 数组</h1><h2 id="_01-一维数组" tabindex="-1"><a class="header-anchor" href="#_01-一维数组" aria-hidden="true">#</a> 01 一维数组</h2><h3 id="_1-1-定义方式" tabindex="-1"><a class="header-anchor" href="#_1-1-定义方式" aria-hidden="true">#</a> 1.1 定义方式</h3><ol><li><code>数组类型 数组名[数组长度];</code></li><li><code>数组类型 数组名[数组长度] = {1,2,3};</code></li><li><code>数组类型 数组名[] = {1,2,3};</code></li></ol><h3 id="_1-2-sizeof与数组" tabindex="-1"><a class="header-anchor" href="#_1-2-sizeof与数组" aria-hidden="true">#</a> 1.2 sizeof与数组</h3><div class="language-C++ line-numbers-mode" data-ext="C++"><pre class="language-C++"><code>sizeof(arr); //获取数组占用总空间
