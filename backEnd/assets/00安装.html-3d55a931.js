import{_ as t,M as l,p as o,q as r,R as n,t as e,N as a,a1 as i}from"./framework-96b046e1.js";const c={},p=i(`<blockquote><p>安装包</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 关于web自动化
pip install selenium
# 安装完后记下安装路径
# 下载谷歌驱动
# 将谷歌驱动放在selenium下
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),d={href:"https://registry.npmmirror.com/binary.html?path=chromedriver/",target:"_blank",rel:"noopener noreferrer"},u=i(`<div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 运行python代码</span>
