import{_ as n,p as i,q as e,a1 as s}from"./framework-96b046e1.js";const l={},d=s(`<h1 id="_08-数据类型" tabindex="-1"><a class="header-anchor" href="#_08-数据类型" aria-hidden="true">#</a> 08 -数据类型</h1><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--
1.MySQL为什么要提供数据类型?
