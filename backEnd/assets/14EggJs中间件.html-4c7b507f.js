import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const p={},t=e(`<h1 id="_14-eggjs中间件" tabindex="-1"><a class="header-anchor" href="#_14-eggjs中间件" aria-hidden="true">#</a> 14 EggJs中间件</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/*
1.EggJS中间件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,10),o=[t];function c(l,i){return s(),a("div",null,o)}const u=n(p,[["render",c],["__file","14EggJs中间件.html.vue"]]);export{u as default};
