import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const i={},l=e(`<h1 id="_09-eggjs处理日志" tabindex="-1"><a class="header-anchor" href="#_09-eggjs处理日志" aria-hidden="true">#</a> 09 EggJs处理日志</h1><p><code>指南--&gt;核心功能--&gt;日志</code></p><h2 id="_1-eggjs日志分类" tabindex="-1"><a class="header-anchor" href="#_1-eggjs日志分类" aria-hidden="true">#</a> 1.EggJs日志分类</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>    <span class="token comment">/*
    EggJS如何处理日志?
