import{_ as e,p as i,q as n,a1 as a}from"./framework-96b046e1.js";const d={},s=a(`<h1 id="_04-继承" tabindex="-1"><a class="header-anchor" href="#_04-继承" aria-hidden="true">#</a> 04 继承</h1><hr><h2 id="title-继承" tabindex="-1"><a class="header-anchor" href="#title-继承" aria-hidden="true">#</a> title: 继承</h2><p>话不多说，先新建三个类：父类、子类、主类。</p><p>父类：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package 继承;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,23),l=[s];function t(r,c){return i(),n("div",null,l)}const u=e(d,[["render",t],["__file","04继承.html.vue"]]);export{u as default};
