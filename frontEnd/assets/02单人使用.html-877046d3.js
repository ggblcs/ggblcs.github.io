import{_ as i,p as e,q as d,a1 as l}from"./framework-96b046e1.js";const s={},n=l(`<h1 id="_02-单人使用" tabindex="-1"><a class="header-anchor" href="#_02-单人使用" aria-hidden="true">#</a> 02 单人使用</h1><h2 id="提炼" tabindex="-1"><a class="header-anchor" href="#提炼" aria-hidden="true">#</a> 提炼</h2><p>设置名字，邮箱</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>git config --global user.name &quot;姓名&quot;
git config --global user.email &quot;邮箱&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>生成密钥</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>ssh-keygen -t rsa -C &quot;2625402133@qq.com&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查看公钥</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>cat ~/.ssh/id_rsa.pub
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_01-本地使用" tabindex="-1"><a class="header-anchor" href="#_01-本地使用" aria-hidden="true">#</a> 01 本地使用</h2><ol><li>在工作区下打开git终端输入<code>git init</code>初始化，创建版本库（.git文件夹）。</li><li><code>git config -l</code>查看所有git的配置，这写配置我们不需要更改，但我们需要新增两项内容。</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>单人流程:
    一、准备工作(只做一次):
    1.创建一个工作区
   2.在工作区中的打开git终端
