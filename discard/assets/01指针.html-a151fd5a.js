import{_ as e,M as t,p,q as i,R as n,t as s,N as c,a1 as o}from"./framework-96b046e1.js";const l={},d=n("h2",{id:"_00-安装win环境下的编译器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_00-安装win环境下的编译器","aria-hidden":"true"},"#"),s(" 00 安装win环境下的编译器")],-1),r={href:"https://sourceforge.net/projects/mingw-w64/files/",target:"_blank",rel:"noopener noreferrer"},u=o(`<p>下载较慢，或者阿里云盘安装包323</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>下载 x86_64-posix-seh
