import{_ as n,p as s,q as a,a1 as t}from"./framework-96b046e1.js";const p={},e=t(`<h1 id="_07-cross-env使用" tabindex="-1"><a class="header-anchor" href="#_07-cross-env使用" aria-hidden="true">#</a> 07 Cross-env使用</h1><p>补充</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>set NODE_ENV 基于会话，关闭窗口失效
