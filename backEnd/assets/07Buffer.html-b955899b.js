import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const i={},l=e(`<h1 id="_07-buffer" tabindex="-1"><a class="header-anchor" href="#_07-buffer" aria-hidden="true">#</a> 07 Buffer</h1><h2 id="_01-buffer类" tabindex="-1"><a class="header-anchor" href="#_01-buffer类" aria-hidden="true">#</a> 01 Buffer类</h2><p>用法写的并不全面，想要全面得搜node api。</p><ol><li>Buffer.from(来自)</li><li>Buffer.alloc</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>0.准备知识
