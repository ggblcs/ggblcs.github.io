import{_ as n,p as s,q as e,a1 as a}from"./framework-96b046e1.js";const t={},l=a(`<h1 id="_15-条件和分布式条件类型" tabindex="-1"><a class="header-anchor" href="#_15-条件和分布式条件类型" aria-hidden="true">#</a> 15 条件和分布式条件类型</h1><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">/*
1.条件类型(三目运算)
