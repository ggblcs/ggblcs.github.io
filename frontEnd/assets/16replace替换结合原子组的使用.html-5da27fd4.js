import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},p=e(`<h1 id="_16-replace替换结合原子组的使用" tabindex="-1"><a class="header-anchor" href="#_16-replace替换结合原子组的使用" aria-hidden="true">#</a> 16 replace替换结合原子组的使用</h1><ol><li>原子组可用$1, $2来对应。</li><li>replace回调，参数与匹配的带有index，group属性的数组一致，并且return啥就把匹配到的内容替换为啥。</li></ol><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>
