import{_ as n,p as i,q as e,a1 as s}from"./framework-96b046e1.js";const l={},d=s(`<h1 id="_09-数据库完整性" tabindex="-1"><a class="header-anchor" href="#_09-数据库完整性" aria-hidden="true">#</a> 09 -数据库完整性</h1><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--
1.什么是数据的完整性?
保证保存到数据库中的数据都是正确的。
