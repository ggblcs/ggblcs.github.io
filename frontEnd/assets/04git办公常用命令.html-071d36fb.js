import{_ as n,p as s,q as a,a1 as i}from"./framework-96b046e1.js";const e={},t=i(`<h1 id="_04-git办公常用命令" tabindex="-1"><a class="header-anchor" href="#_04-git办公常用命令" aria-hidden="true">#</a> 04 git办公常用命令</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>基本用法
...
（1）新建分支
<span class="token function">git</span> branch xxx <span class="token punctuation">(</span>xxx填写你的分支名称

----------------
<span class="token function">git</span> push --set-upstream origin zhao
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),c=[t];function l(r,o){return s(),a("div",null,c)}const p=n(e,[["render",l],["__file","04git办公常用命令.html.vue"]]);export{p as default};
