import{_ as n,p as s,q as a,a1 as p}from"./framework-96b046e1.js";const t={},e=p(`<h1 id="_84-清除默认样式" tabindex="-1"><a class="header-anchor" href="#_84-清除默认样式" aria-hidden="true">#</a> 84 清除默认样式</h1><p>在main.js导入reset.css即可。<strong>懂了就不用看了</strong></p><p>新加：px的p改成大写P就不会被转为rem了。</p><p>在assets中新建css目录放入以下scss文件(4个)，然后在main.js只导入base即可。</p><p>base.scss</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token atrule"><span class="token rule">@import</span> <span class="token string">&quot;./reset.scss&quot;</span><span class="token punctuation">;</span></span>
